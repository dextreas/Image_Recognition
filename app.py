...
class App:
    ...
    def init_gui(self):
        ...
        self.classname_one = simpledialog.askstring("Classname One", "Enter the name of Item 1:", parent=self.window)
        self.classname_two = simpledialog.askstring("Classname Two", "Enter the name of Item 2:", parent=self.window)
        ...
        for folder in ['1', '2']:
            for file in os.listdir(folder):
                ...
                try:
                    ...
                    os.unlink(file_path)  # Now it's safe to delete
